...
import { SetFrontal } from '__src/app/@store/actions/frontal.action';
import { BALState } from '__src/app/@shared/models/State';
import { SetBALState } from '__src/app/@store/actions/bal-state.action';
import { ReferentielService } from '__src/app/@core/services/referentiel.service';
